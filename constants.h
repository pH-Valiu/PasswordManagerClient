...
namespace SECURITY_CONSTANTS{
    static const int MASTER_PW_PBKDF_ITERATIONS = 100000;
    static const int USER_MASTER_PW_HASH_ITERATIONS = 100000;
    static const int DATA_ENTRY_MID_KEY_PBKDF_ITERATIONS = 100000;
    static const int DATA_ENTRY_MID_KEY_HASH_ITERATIONS = 100000;
